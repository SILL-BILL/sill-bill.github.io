...
function initObject() {
	...
	//形状オブジェクトの宣言と生成
	var geometry = new THREE.SphereGeometry(50, 30, 30, 0, 2 * Math.PI, 0, Math.PI);
	//材質オブジェクトの宣言と生成
	var material = new THREE.MeshNormalMaterial({'wireframe':true, 'wireframeLinewidth':3});
	//var material = new THREE.MeshNormalMaterial({ shading: THREE.SmoothShading/*, side: THREE.DoubleSide*/ });
	//球オブジェクトの生成
