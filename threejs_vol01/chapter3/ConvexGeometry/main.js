...
function initObject() {
	...
	//凸型オブジェクトの頂点座標
	var vertices = [];
	vertices[0] = new THREE.Vector3(-50, 0, -50);
	vertices[1] = new THREE.Vector3(-50, 0, 50);
	vertices[2] = new THREE.Vector3(50, 0, 50);
	vertices[3] = new THREE.Vector3(50, 0, -50);
	vertices[4] = new THREE.Vector3(0, 60, 0);
//	vertices[5] = new THREE.Vector3(0, -60, 0);
