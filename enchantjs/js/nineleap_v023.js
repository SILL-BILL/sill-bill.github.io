// forked from 9leap's "nineleap.enchant" http://jsdo.it/9leap/nineleap.enchant
/** nineleap-jsdoit.enchant.js v0.2.3 (2011/06/10)
 * 
 * enchant.js extention for 9leap.net / jsdo.it
...
(function() {
    ...
    enchant.nineleap = { assets: ['http://wise9.github.com/enchant.js/images/start.png', 'http://wise9.github.com/enchant.js/images/gameover.png'] };
    enchant.nineleap.Game = enchant.Class.create(enchant.Game, {
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets['http://wise9.github.com/enchant.js/images/start.png'];
                ...
                this.endScene.image = this.assets['http://wise9.github.com/enchant.js/images/gameover.png'];
        ...
        _setTwitterAssets: function(resBody, requestType, checkError) {
            ...
            if (resBody[0] == undefined) {
                ...
                if (resBody[0].code == 401 && this.requireAuth) {
                    ...
                    alert (resBody[0].code + ' error' + '¥n繝ｪ繝ｭ繝ｼ繝峨＠縺ｦ縺ｿ縺ｦ縺上□縺輔＞');
